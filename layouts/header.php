...
<head>
    ...
    <title>Pet Shop::Trung tâm thú cưng IVYVET</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="shortcut icon" href="<?php echo URL.'/styles/'?>img/Logo_1.png">
    <!-- icofont css -->
                        ...
                        <nav>
                            <ul class="header-menu-list text-center">
                                ...
                                <li class="static_class">
                                    <a class="drop-icon" href="shop.html">Danh mục sản phẩm</a>
                                    <ul class="common_ddown megamenu mega_style_2">
                                        <li>
                                            <ul>
                                                <li class="menu-tile">Mega Title</li>
                                                <li>
                                ...
                                <li><a href="shop.html">Các thương hiệu</a></li>
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-footer">
                                                ...
                                                <div class="cart-actions text-center">
                                                    ...
                                                    <a class="cart-checkout" href="#">Giỏ hàng</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
